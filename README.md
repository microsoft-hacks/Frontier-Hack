...
| 🏭 **Electric Plant (SDK)** | Classify fictional drive conditions and plan maintenance at Northline Motion Works | [lab](./labs/electric-plant/README.md) |
| 🏭 **Electric Plant (Portal)** | The same fictional industrial scenario with no agent code | [lab](./labs/electric-plant-portal/README.md) |
