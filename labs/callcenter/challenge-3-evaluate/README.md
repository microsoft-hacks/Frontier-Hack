...
6. Click **Upload new dataset**. First, you need to enter a name for the dataset — upload will remain disabled until you do so. Enter a name (for example, `callcenter-eval`), then add the file located at `labs/callcenter/challenge-3-evaluate/eval_portal.jsonl` and confirm the upload.
